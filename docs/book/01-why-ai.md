...
- 실무자가 이해해야 할 **최소한의 개념과 기준**

이 장은 이후 장들의 전체 논리를 연결하는 “기초 공사”다. 그리고 이 안내서가 강조하는 **“실험을 넘어 에이전트 스케일로, 비즈니스 프로세스 재설계”**라는 메시지의 이론적 기반을 제공한다.
...
멀티모달은 현업 업무에 특히 중요하다. 예를 들어, 회의 녹음 파일을 텍스트로 바꾸고 요약하는 것, 제품 사진을 분석해 설명을 작성하는 것, 문서 안의 표를 요약하는 것 등이 가능해진다.
...
즉, AI는 더 이상 “대화형 지식 도구”가 아니라 **업무의 일부를 대신 실행할 수 있는 흐름**을 제공한다. 이 변화는 현업 업무에도 큰 영향을 준다.
...
특히 현업 업무(보고서, 회의, 의사결정 지원)는 **인건비 비중이 높기 때문에**, AI의 효율화 효과가 빠르게 보인다.
...
## 4. 조직적 배경: 왜 실무자가 핵심인가
### 4-1. AI는 기술자만의 도구가 아니다
AI의 효과가 큰 영역은 의외로 **현업 업무**다.  
개발자는 시스템을 만들지만, **사용자는 실무자**이기 때문이다.
...
즉, 실무자는 AI를 “써야 하는 대상”이 아니라 **AI 활용의 핵심 주체**다.

### 4-3. 변화 관리의 중요성
기술은 빠르게 도입할 수 있지만, 조직 변화는 시간이 필요하다.  
실무자가 AI를 잘 쓰기 위해서는 **교육, 가이드, 문화**가 필요하다.  
...
이 단계의 특징은 “AI가 필요할 것 같다”는 공감대 형성이다. 교육과 세미나가 이루어지고, 리더가 관심을 표현한다. 그러나 아직 구체적 업무에는 적용되지 않는다. 이 단계는 “기술의 가능성”을 이해하는 시기다. 실무자에게 중요한 것은 **기본 용어와 한계를 인식하는 것**이다.
...
실무자가 직접 사용해보고, 문제를 발견하고, 개선을 제안하는 과정이 필요하다. 이것이 없으면 AI는 “남의 도구”가 된다.
...
실무자도 “데이터 사고”와 “업무 설계” 역량이 요구된다. 이는 교육과 인력 개발의 방향을 바꾸게 된다.
...
### 28-1. 규제와 제도 환경
한국은 AI 기본법 등 AI 관련 제도화 흐름이 빠르게 진행되고 있다. 예를 들어 AI 기본법이 2024년 12월 통과하면서, AI 활용이 더 이상 “기업 내부의 선택”만이 아니라 **법과 사회가 요구하는 기준**과 연결된다는 점이 더 분명해졌다.  
...
셋째, 실무자가 AI 활용의 중심이며, 조직의 성과는 결국 **사람과 프로세스의 변화**에 달려 있다는 점이다.
...
## 33. 독자를 위한 관점 정리
실무자 관점에서 AI를 이해할 때 가장 중요한 것은 “내가 무엇을 더 잘 판단할 수 있게 되는가”다.  
