...
또한 AI 결과의 사용 범위를 명확히 해야 한다. 내부 참고용인지, 외부 공개용인지에 따라 표현 수준과 검토 절차가 달라진다. 프롬프트에 “내부 검토용 초안”이라고 명시하면, AI가 보수적으로 표현하도록 유도할 수 있다. 반대로 외부 공개용 문서는 더 엄격한 검토가 필요하다. 프롬프트는 문서의 **사용 범위와 책임**을 표시하는 라벨이 된다.
